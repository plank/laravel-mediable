...
{
    public static function strictTypeMismatch(string $mime, string $ext)
    {
        return new static("File with mime of `{$mime}` not recognized for extension `{$ext}`.");
    }

    public static function unrecognizedFileType(string $mime, string $ext)
    {
        return new static("File with mime of `{$mime}` and extension `{$ext}` is not recognized.");
    }

    public static function mimeRestricted(string $mime, array $allowed_mimes)
    {
    ...
    public static function extensionRestricted(string $extension, array $allowed_extensions)
    {
    ...
    public static function aggregateTypeRestricted(string $type, array $allowed_types)
    {
